...
<body>
<main>
    <section class="bg-white dark:bg-gray-900 mt-[70px]">
       <div class="container mx-auto px-6 py-16 text-center">
            <div class="mx-auto max-w-lg">
                <h1 class="text-3xl font-bold text-gray-800 dark:text-white lg:text-4xl">welcome in <span class="text-blue-600">Marjane</span> </h1>

            </div>

            <div class="mt-10 flex justify-center">
                <img class="h-96 w-full rounded-xl object-cover lg:w-4/5" src="https://www.moroccoworldnews.com/wp-content/uploads/2020/08/Marjane-Closes-2-Markets-in-Marrakech-After-COVID-19-Outbreaks-2.jpg" />
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto -mt-72 px-6 py-10 sm:-mt-80 md:-mt-96">
            <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-3">
                <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
                    <img class="aspect-square w-full rounded-xl object-cover" src="https://intranet.youcode.ma/storage/users/profile/226-1664893141.JPG" alt="" />

                    <h1 class="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">taha lechgar</h1>
                ...
                <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
                    <img class="aspect-square w-full rounded-xl object-cover" src="https://media-exp1.licdn.com/dms/image/D4D03AQEwfPycmPu2ng/profile-displayphoto-shrink_800_800/0/1649514634010?e=1674086400&v=beta&t=RalCULphvdjOHD6abL2J3N08AUBSa9ovwTiAlBkzUJY" alt="" />
                ...
                <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
                    <img class="aspect-square w-full rounded-xl object-cover" src="https://media-exp1.licdn.com/dms/image/D4E03AQFQ7al6hUbDIg/profile-displayphoto-shrink_400_400/0/1664928030709?e=1674086400&v=beta&t=E31fKSZP0-NzbDZEHylRa_145QNTjVtxMeHSgUwBL2Q" alt="" />
                ...
                <div class="text-white lg:mx-6 lg:w-1/2">
                    ...
                    <div class="mt-6 space-y-8 md:mt-8">
                        <p class="-mx-2 flex items-start">
                            ...
                            <span class="mx-2 w-72 truncate text-white"> ouislane 711-2880 meknes .morocco 5000 </span>
                        </p>
                        ...
                        <p class="-mx-2 flex items-start">
                            ...
                            <span class="mx-2 w-72 truncate text-white">+212 890-89 903</span>
                        </p>
                        ...
                        <p class="-mx-2 flex items-start">
                            ...
                            <span class="mx-2 w-72 truncate text-white">the.staili.abdessalm@gmail.com</span>
                        </p>
                    </div>
