...
<body>
<% List<Manager> Allcenteradmin = (ArrayList<Manager>)request.getAttribute("AllManager");%>
...
<div class="overflow-x-auto relative shadow-md sm:rounded-lg mt-[60px]">
  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
    ...
    <tbody>
    <%for(Manager centerAdmin:Allcenteradmin){%>
    <tr class="border-b border-gray-200 dark:border-gray-700">
      ...
      <td class="py-4 px-6">
        <%=centerAdmin.getMfullname()%>
      </td>
      <td class="py-4 px-6 bg-gray-50 dark:bg-gray-800">
        <%=centerAdmin.getMemail()%>
      </td>
    </tr>
    <%}%>
    </tbody>
