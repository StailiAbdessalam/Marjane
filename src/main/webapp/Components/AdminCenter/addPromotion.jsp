      ...
      <div class="max-w-md mx-auto">
        ...
        <div class="divide-y divide-gray-200">
            ...
            <div class="pt-4 flex items-center space-x-4">
              <button data-modal-toggle="add_promotion" type="button"  class="flex justify-center items-center w-full text-gray-900 px-4 py-3 rounded-md focus:outline-none">
